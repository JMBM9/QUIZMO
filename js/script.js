...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span>and congrats!  <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        ...
        let scoreTag = '<span>welp its OVER!, You got only <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
...
let questions = [
    ...
    {
    numb: 2,
    question: "Who won the 2018 Moncao Grand Prix?",
    ...
    {
    numb: 3,
    question: "Who has made the most buzzet beaters in NBA history?",
    answer: "Lebron James",
    options: [
      "Michael Jordan",
      "Kobe Bryant",
    ...
    {
    numb: 4,
    question: "Who has the most Championships as a Quarterback in the NFL?",
    answer: "Tom Brady",
    options: [
      "Tom Brady",
      "Brett Favre",
